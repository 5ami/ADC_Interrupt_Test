...
gpio_dev_t *dev2 = GPIO_LL_GET_HW(GPIO_PORT_0);
...
{   
    ...
    /*End of the Interrupt up the Interrupt*/
    /*
     Just pour fair un petit test 
     tester avec la fonction PWM  -- Marche bien en mode PWM mais pas ADC
     recule vers mode assembleur
     pour avoir s que c  un problem de  interrupt ou pas.  
    */
